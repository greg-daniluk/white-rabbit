...
% 
%       \begin{center}
%       \includegraphics[width=1.0\textwidth]{misc/GMT-2.eps} 
...
\begin{frame}{Synchronous Ethernet (SyncE)}
  ...
  \end{itemize}
  \includegraphics[width=.9\textwidth]{misc/synce.eps}
  \end{center}
...
%     \includegraphics<1>[width=0.65\textwidth]{network/wr_network-new.ps} \pause
    \includegraphics[width=0.9\textwidth]{applications/CERN/event3.eps}
    \end{center}
...
\begin{frame}{White Rabbit Network Components}
    ...
    \includegraphics[width=1.0\textwidth]{network/WRnetwork-eva.eps}  
...
\begin{frame}{WR Node: WR PTP Core}
    ...
    \begin{center}
    \includegraphics[width=1.0\textwidth]{node/wrpc_box.eps}
    \end{center}
...
\begin{frame}{CERN Neutrinos to Gran Sasso (CNGS)}
    ...
    \begin{center}
      \includegraphics[height=0.5\textheight]{applications/cngs-general.eps}
...
%       \includegraphics<1>[height=0.5\textheight]{figs/cngs-general.v2.eps} \pause
      \includegraphics[height=0.7\textheight]{applications/cngs-timing-31.eps}
    \end{center}
...
% 
%     \begin{center}
%       \includegraphics[width=1.0\textwidth]{applications/ni.eps} 
%     \end{center}
% 
% \end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% 
%   \begin{center}
%   \includegraphics[width=11.8cm]{protocol/wrCRS+mBMC.eps}
%   \end{center}
% 
% \end{frame}
