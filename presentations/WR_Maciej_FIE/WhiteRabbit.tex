...
% 
%       \begin{center}
%       \includegraphics[width=1.0\textwidth]{misc/GMT-2.pdf} 
...
\begin{frame}{Time Distribution in White Rabbit Network}
  ...
  \end{itemize}
%     \begin{center}
%       \includegraphics[width=1.0\textwidth]{fig/phase_tracking.pdf}
%     \end{center}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% \section{}
...
\begin{frame}{CERN Neutrinos to Gran Sasso (CNGS)}
    ...
    \begin{center}
%       \includegraphics<1>[height=0.5\textheight]{figs/cngs-general.v2.pdf} \pause
