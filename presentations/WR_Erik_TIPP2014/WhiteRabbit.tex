...
%    \includegraphics[height=1.0\textwidth]{network/wr_network-new.pdf}
   \includegraphics[height=1.0\textwidth]{network/wr_network-enhanced_pro.jpg}
    \end{center}
\end{columns}
...
% 
  \column{0.6\textwidth}
    \begin{center}
    \includegraphics[width=0.8\textwidth]{network/wr_network-enhanced_pro.jpg}
    \end{center}
\end{columns}
\end{frame}
...
%       \includegraphics[width=.8\textwidth]{applications/CERN/NT-overview.pdf}
      \includegraphics[width=.7\textwidth]{applications/CERN/NT-overview.jpg}
    \end{center}
...
%  \begin{center}
%    \includegraphics[width=1.0\textwidth]{misc/commercial_vs_proprietary.ps}
%  \end{center}
%  \begin{itemize}
%    \item Get a design just the way we want it
%    \item Peer review
...
\begin{frame}{Dispelling the commercial vs open myth}
 \begin{center}
   \includegraphics[height=5.8cm]{ohwr/commercial_vs_proprietary.png}
 \end{center} 
\end{frame}
