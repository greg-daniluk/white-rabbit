...
%  \column{0.6\textwidth}
%    \begin{center}
%    \includegraphics[width=0.65\textwidth]{network/wr_network-enhanced_pro.pdf}
%    \end{center}
%\end{columns}
%\end{frame}
...
%  \column{0.6\textwidth}
%    \begin{center}
%    \includegraphics<1>[width=0.65\textwidth]{network/wr_network-enhanced_pro.pdf}% \pause
