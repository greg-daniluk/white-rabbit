...
\begin{columns}[c]
	...
	\column{0.3\textwidth}
		\begin{center}
		\hspace{-0.5cm}
%		\includegraphics[width=1.1\textwidth]{../../figures/misc/rabbit.eps}  erik
...
%     \includegraphics[width=1.0\textwidth]{../../figures/network/WR_network-ethernet.pdf}
...
%     \includegraphics[width=1.0\textwidth]{../../figures/network/wr_network-enhanced.pdf}
...
%    \includegraphics[height=1.0\textwidth]{../../figures/network/wr_network-new.pdf}
   \includegraphics[height=1.0\textwidth]{../../figures/network/wr_network-enhanced_pro.jpg}
    \end{center}
\end{columns}
...
%   \includegraphics[height=2.7cm]{../../figures/misc/phase_tracking.pdf}
...
%    \includegraphics<1>[height=7.0cm]{../../figures/measurements/measSystem.pdf}   \pause
...
%	\column{0.6\textwidth}
%		\begin{center}
%		\includegraphics[width=0.9\textwidth]{../../figures/measurements/MTIE2.pdf}
%		\end{center}
%  \end{columns}
%\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% 
  \column{0.6\textwidth}
    \begin{center}
    \includegraphics[width=0.8\textwidth]{../../figures/network/wr_network-enhanced_pro.jpg}
    \end{center}
\end{columns}
\end{frame}
...
%  \column{0.6\textwidth}
%    \begin{center}
%    \includegraphics[width=0.65\textwidth]{../../figures/network/wr_network-enhanced_pro.jpg}
%    \end{center}
%\end{columns}
%\end{frame}
...
%  \column{0.6\textwidth}
%    \begin{center}
%    \includegraphics<1>[width=0.65\textwidth]{../../figures/network/wr_network-enhanced_pro.jpg}% \pause
%%    \includegraphics<2>[width=0.9\textwidth]{../../figures/robustness/event3.pdf} 
%    \end{center}
%
%\end{columns}
%
...
\begin{frame}{White Rabbit Network Components}
    ...
    \begin{center}
    \includegraphics<1>[width=1.0\textwidth]{../../figures/network/WRnetwork-eva.pdf}  % \pause
%    \includegraphics<2>[width=1.0\textwidth]{../../figures/network/WRNcomponents-2.pdf}
    \end{center}
...
\begin{frame}{White Rabbit Switch (V3)}
    ...
    \begin{center}
%     \includegraphics[width=6.0cm]{../../figures/switch/wrSwitchV3.pdf}
...
\begin{frame}{WR Node: WR PTP Core}
    ...
    \begin{center}
%    \includegraphics<1>[width=1.0\textwidth]{../../figures/node/wrpc_box.pdf} \pause%
...
\begin{frame}{WR Node: SPEC board}
    ...
    \begin{center}
%    \includegraphics[width=7cm]{../../figures/node/shw_kit-1.pdf}
...
%
%    \begin{center}
%      \includegraphics<1>[width=0.7\textwidth]{../../figures/node/stm.pdf}   \pause
%      \includegraphics<2>[width=0.8\textwidth]{../../figures/node/spexi_v0.png} 
%    \end{center}
%
%    \column{.01\textwidth}
%  \end{columns}
...
\begin{frame}{WR at CERN}
    ...
    \begin{center}
%       \includegraphics[width=.8\textwidth]{../../figures/applications/CERN/NT-overview.pdf}
      \includegraphics[width=.7\textwidth]{../../figures/applications/CERN/NT-overview.jpg}
    \end{center}
...
%    \column{.4\textwidth}
%      \begin{center}
%	\includegraphics[width=0.9\textwidth]{../../figures/applications/CNGS2.pdf}
%      \end{center}
%    \column{.01\textwidth}
%  \end{columns}
%\end{frame}
...
%  \begin{center}
%    \includegraphics[width=1.0\textwidth]{../../figures/misc/commercial_vs_proprietary.ps}
%  \end{center}
%  \begin{itemize}
%    \item Get a design just the way we want it
%    \item Peer review
...
\begin{frame}{Dispelling the commercial vs open myth}
 \begin{center}
   \includegraphics[height=5.8cm]{../../figures/ohwr/commercial_vs_proprietary.png}
 \end{center} 
\end{frame}
...
\begin{columns}[c]
  ...
  \column{0.6\textwidth}
    \begin{center}
      \includegraphics[width=6.5cm]{../../figures/applications/CERN/accelerators.pdf}
    \end{center}
\end{columns}
...
\begin{frame}{A simplified explanation of CERN control system (1)}
      ...
      \begin{center}
      \includegraphics[width=1.0\textwidth]{../../figures/applications/CERN/event1.pdf}
      \end{center}
...
\begin{frame}{A simplified explanation of CERN control system (2)}
      ...
      \begin{center}
      \includegraphics[width=1.0\textwidth]{../../figures/applications/CERN/event2.pdf}
      \end{center}
...
\begin{frame}{A simplified explanation of CERN control system (3)}
      ...
      \begin{center}
      \includegraphics[width=.8\textwidth]{../../figures/applications/CERN/event3.pdf}
      \end{center}
...
\begin{columns}[c]
  ...
  \column{0.6\textwidth}
    \begin{center}
      \begin{center}
      \includegraphics[width=.8\textwidth]{../../figures/applications/CERN/gw.pdf}
      \end{center}
    \end{center}
\end{columns}
...
\begin{frame}{A simplified explanation of CERN control system (5)}
      ...
      \begin{center}
      \includegraphics[width=.7\textwidth]{../../figures/applications/CERN/accNetworks.pdf}
      \end{center}
...
%    \item Reliability-oriented.
  ...
  \begin{center}
  \includegraphics[height=3cm]{../../figures/protocol/wrLink.pdf}
  \end{center}
...
\begin{frame}{Fine Delay Measurement}
  ...
  \begin{center}
  \includegraphics[width=10.0cm]{../../figures/protocol/link_model.pdf}
  \end{center}
...
\begin{frame}{Link Asymmetry}
  ...
  \begin{center}
  \includegraphics[height=4cm]{../../figures/protocol/wrLinkModel_init.pdf}
  \end{center}
...
\begin{frame}{Link Delay Model}
  ...
  \begin{center}
DELAYMODEL.EPS FILE
%  \includegraphics[height=2.5cm]{../../figures/protocol/delaymodel.eps}   ERIK PROBLEM CONVERTING FILE
  \end{center}
...
\begin{frame}{Fixed Delays}
  ...
  \begin{center}
  \includegraphics[width=11.0cm]{../../figures/protocol/asymmetries.pdf}
  \end{center}
...
\begin{frame}{WR-peer recognition and WR-data exchange}
  ...
  \column{.5\textwidth} 
    ...
    \begin{center}
    \includegraphics[width=5.0cm]{../../figures/protocol/WR-peer_recognision-1.pdf}
    \newline
    Two WR devices
    \end{center}
  ...
  \column{.5\textwidth}
    ...
    \begin{center}
    \includegraphics[width=5.0cm]{../../figures/protocol/WR-peer_recognision-2.pdf}
    \newline
...
\begin{frame}{WR Link Setup }
  ...
  \column{.5\textwidth} 
      ...
      \begin{center}
      \includegraphics[width=5.5cm]{../../figures/protocol/wrLinkSetup.pdf}
      \end{center}
...
\begin{frame}{Modified Best Master Clock Algorithm (mBMCA)}
    ...
    \begin{center}
    \includegraphics[height=7.0cm]{../../figures/protocol/mBMCvsBMC.pdf}
    \end{center}
...
%{\it [problem with a presentation flow]}
  ...
  \begin{center}
  \includegraphics[width=11.8cm]{../../figures/protocol/wrCRS_plus_mBMC.pdf}
  \end{center}
