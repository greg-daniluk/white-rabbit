...
\begin{frame}{Sieć White Rabbit}
    ...
    \begin{center}
    \includegraphics[width=1.0\textwidth]{../../figures/applications/CERN/WRcontrol.ps}
    \end{center}
...
\begin{columns}[c]
  ...
  \begin{center}
  \includegraphics[height=2.5cm]{../../figures/protocol/wrLink.ps}
  \end{center}
  ...
  \begin{center}
  \includegraphics[height=2.6cm]{../../figures/misc/Accuracy_and_precision.ps}
  \end{center}
...
% \subsection{}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\setbeamertemplate{background}{\includegraphics[width=\paperwidth]{../../figures/protocol/wrLinkModel-fdm2.ps}}
\logo{}
...
%\subsection{}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\setbeamertemplate{background}{\includegraphics[width=\paperwidth]{../../figures/protocol/wrLinkModel-fd.ps}}
\logo{}
...
%{\it [problem with a presentation flow]}
  ...
  \begin{center}
  \includegraphics[width=10cm]{../../figures/robustness/wrCRS2.ps}
  \end{center}
...
\begin{frame}{Testy: wpływ temperatury na synchronizację}
    ...
    \begin{center}
    \includegraphics[height=6.0cm]{../../figures/measurements/meas_system_wrcore.ps}
    \end{center}
...
\begin{frame}{Testy : Delay vs. temperature}
  ...
  \begin{center}
  \includegraphics[width=7cm]{../../figures/measurements/wrpc_delay_vs_temp.eps}
...
\begin{frame}{Testy: Offset vs. temperature}
  ...
  \begin{center}
    \includegraphics[width=7cm]{../../figures/measurements/wrpc_offset_vs_temp.eps}
  \end{center}
  \begin{itemize}
...
\begin{frame}{Dystrybucja danych kontrolnych}
    ...
    \begin{center}
    \includegraphics[width=1.1\textwidth]{../../figures/applications/CERN/WRControlNetwork.ps}
    \end{center}
...
\begin{frame}{Niezawodny przesył danych}
  ...
  \column{.4\textwidth} 
      ...
      \begin{center}
      \includegraphics[width=4.5cm]{../../figures/robustness/CommunicationChannel.ps}
      \end{center}
...
\begin{frame}{Forward Error Correction}
	...
	\end{itemize}    
      ...
      \begin{center}
      \includegraphics[width=1.0\textwidth]{../../figures/robustness/FECencoder.ps}
      \end{center}
...
\begin{frame}{Niezawodność sieci}
  ...
  \column{.5\textwidth} 
      ...
      \begin{center}
      \includegraphics[width=6cm]{../../figures/network/wr_network-new.ps}
      \end{center}
...
\begin{frame}{FEC + Nadmiarowość sieci}
  ...
  \end{itemize}
      ...
      \begin{center}
      \includegraphics[width=1.0\textwidth]{../../figures/robustness/FECandRSTP.ps}
      \end{center}
...
\begin{frame}{Determinizm transmisji danych}
  ...
  \column{.5\textwidth} 
      ...
      \begin{center}
      \includegraphics[width=6cm]{../../figures/robustness/latencyEstimation.ps}
      \end{center}
...
\begin{frame}{Elementy systemu White Rabbit}
      ...
      \begin{center}
      \includegraphics[width=7cm]{../../figures/network/wr_network-new.ps}
      \end{center}
...
\begin{frame}{White Rabbit Switch (V2)}
    ...
    \begin{center}
    \includegraphics[width=7.0cm]{../../figures/switch/wrs_v2.ps}
    \end{center}
...
\begin{frame}{White Rabbit Switch (V2)}
    ...
    \begin{center}
    \includegraphics[width=7.0cm]{../../figures/switch/wrs2_sw_block.ps}
    \end{center}
...
\begin{frame}{White Rabbit Node}
  ...
  \column{.6\textwidth} 
    ...
    \begin{center}
    \includegraphics[width=7.0cm]{../../figures/node/wr_node_block.eps}
    \end{center}
...
%  \column{.5\textwidth} 
    ...
    \begin{center}
    \includegraphics[width=8.0cm]{../../figures/node/wrpc_v1.ps}
    \end{center}
...
\begin{frame}{Simple PCIe FMC carrier (SPEC)}
    ...
    \begin{center}
    \includegraphics[width=8.0cm]{../../figures/node/spec_photo.ps}
    \end{center}
