...
\begin{frame}{Sieć White Rabbit}
    ...
    \begin{center}
    \includegraphics[width=1.0\textwidth]{fig/WRcontrol.ps}
    \end{center}
...
\begin{columns}[c]
  ...
  \begin{center}
  \includegraphics[height=2.5cm]{fig/wrLink.ps}
  \end{center}
  ...
  \begin{center}
  \includegraphics[height=2.6cm]{fig/Accuracy_and_precision.ps}
  \end{center}
...
%{\it [problem with a presentation flow]}
  ...
  \begin{center}
  \includegraphics[width=10cm]{fig/wrCRS2.ps}
  \end{center}
...
\begin{frame}{Testy: synchronizacja w układzie kaskadowym}
    ...
    \begin{center}
    \includegraphics[height=7.0cm]{fig/measSystem.ps}
    \end{center}
...
\begin{frame}{Testy: synchronizacja w układzie kaskadowym}
    ...
    \begin{center}
    \includegraphics[height=6.0cm]{fig/measResults-new.eps}
    \end{center}
...
\begin{frame}{Testy: wpływ temperatury na synchronizacje}
    ...
    \begin{center}
    \includegraphics[height=6.0cm]{fig/meas_system_wrcore.ps}
    \end{center}
...
\begin{frame}{Testy : Delay vs. temperature}
  ...
  \begin{center}
  \includegraphics[width=7cm]{fig/delay_vs_temp.eps}
...
\begin{frame}{Testy: Offset vs. temperature}
  ...
  \begin{center}
    \includegraphics[width=7cm]{fig/offset_vs_temp.eps}
  \end{center}
  \begin{itemize}
...
\begin{frame}{Dystrybucja danych kontrolnych}
    ...
    \begin{center}
    \includegraphics[width=1.1\textwidth]{fig/WRControlNetwork.ps}
    \end{center}
...
\begin{frame}{Wymagania dot. dystrybucji danych w CERN i GSI}
    ...
    \begin{center}
    \includegraphics[width=1.1\textwidth]{fig/WRControlNetwork2.ps}
    \end{center}
...
\begin{frame}{Niezawodny przesył danych}
  ...
  \column{.4\textwidth} 
      ...
      \begin{center}
      \includegraphics[width=4.5cm]{fig/CommunicationChannel.ps}
      \end{center}
...
\begin{frame}{Forward Error Correction}
	...
	\end{itemize}    
      ...
      \begin{center}
      \includegraphics[width=1.0\textwidth]{fig/FECencoder.ps}
      \end{center}
...
\begin{frame}{Niezawodność sieci}
  ...
  \column{.5\textwidth} 
      ...
      \begin{center}
      \includegraphics[width=6cm]{fig/wr_network-new.ps}
      \end{center}
...
\begin{frame}{FEC + Nadmiarowość sieci}
  ...
  \end{itemize}
      ...
      \begin{center}
      \includegraphics[width=1.0\textwidth]{fig/FECandRSTP.ps}
      \end{center}
...
\begin{frame}{Determinizm transmisji danych}
  ...
  \column{.5\textwidth} 
      ...
      \begin{center}
      \includegraphics[width=6cm]{fig/latencyEstimation.ps}
      \end{center}
...
\begin{frame}{Elementy systemu White Rabbit}
      ...
      \begin{center}
      \includegraphics[width=7cm]{fig/wr_network-new.ps}
      \end{center}
...
\begin{frame}{White Rabbit Switch (V2)}
    ...
    \begin{center}
    \includegraphics[width=7.0cm]{fig/wrs_photo.ps}
    \end{center}
...
\begin{frame}{White Rabbit Switch (V2)}
    ...
    \begin{center}
    \includegraphics[width=7.0cm]{fig/sw_block.ps}
    \end{center}
...
\begin{frame}{White Rabbit Node}
  ...
  \column{.6\textwidth} 
    ...
    \begin{center}
    \includegraphics[width=7.0cm]{fig/wr_node_block.eps}
    \end{center}
...
%  \column{.5\textwidth} 
    ...
    \begin{center}
    \includegraphics[width=8.0cm]{fig/wrpc.ps}
    \end{center}
...
\begin{frame}{Simple PCIe FMC carrier (SPEC)}
    ...
    \begin{center}
    \includegraphics[width=8.0cm]{fig/spec_photo.ps}
    \end{center}
...
\begin{frame}{WR-compliant Hardware Kit}
    ...
    \begin{center}
    \includegraphics[width=6cm]{fig/shw_kit}
    \end{center}
