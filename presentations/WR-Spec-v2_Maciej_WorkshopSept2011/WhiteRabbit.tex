...
\begin{frame}{WR Link Setup}
      ...
      \begin{center}
      \includegraphics[width=9.5cm]{protocol/wrLinkSetupFSM.eps}
      \end{center}
...
\column{.5\textwidth}
    \begin{center}
    \includegraphics[height=5.5cm]{protocol/mBMCvsBMC.eps}
    \end{center}
...
%    \includegraphics[height=4.0cm]{fig/WRlogo.ps}
    \includegraphics[height=3.0cm]{misc/white_rabbit_end.eps}
    \end{center}
