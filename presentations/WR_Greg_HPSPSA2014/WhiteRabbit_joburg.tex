...
\begin{center}
\includegraphics[height=5cm]{misc/Alice-wr.ps}
\end{center}
\begin{center}
...
\begin{frame}{Why we use Open Hardware ?}
  \begin{center}
    \includegraphics[width=.7\textwidth]{ohwr/commercial_vs_proprietary.ps}
  \end{center}
  \begin{itemize}
...
\begin{columns}[c]
	...
	\column{0.5\textwidth}
		\begin{center}
		\includegraphics[width=1.0\textwidth]{misc/rabbit.eps}
		\end{center}
	\end{columns}
...
\begin{columns}[c]
  ...
  \column{.6\textwidth}
    \begin{center}
    \includegraphics[height=1.05\textwidth]{network/wr_network-enhanced_pro.eps}
    \end{center}
\end{columns}
...
\begin{frame}{White Rabbit Node}
  ...
  \end{itemize}
  \begin{center}
  \includegraphics[height=0.5\textheight]{node/shw_kit2.ps}
  \end{center}
\end{frame}
...
\begin{frame}{Layer 1 Syntonization}
  ...
  \begin{center}
    \includegraphics[width=1.0\textwidth]{misc/l1_sync.eps}
  \end{center}
\end{frame}
...
\begin{frame}{Phase measurements}
  ...
  \begin{center}
    \includegraphics[width=1.0\textwidth]{misc/phase_tracking_v2_simple.eps}
  \end{center}
...
\begin{frame}{Data Distribution in a White Rabbit Network }
    ...
    \begin{center}
    \includegraphics[height=0.8\textheight]{robustness/wrn_reliability.ps}
    \end{center}
...
\begin{columns}[c]
  ...
  \column{.6\textwidth}
    \begin{center}
    \includegraphics[height=0.65\textheight]{robustness/communication_channel-pro.eps}
    \end{center}
...
\begin{columns}[c]
  \column{0.45\textwidth}
    ...
    \begin{center}
    \includegraphics[width=1.0\textwidth]{robustness/switchover.eps} 
    \end{center}

  \column{0.6\textwidth}
    \begin{center}
    \includegraphics[width=1.0\textwidth]{robustness/switchover288-ok.eps}
    \end{center}
...
\begin{frame}{Distributed oscilloscope}
  \includegraphics[width=.8\textwidth]{applications/distr_oscill.eps}
  \begin{block}{}
    \begin{itemize}
...
\begin{frame}{CERN Neutrinos to Gran Sasso project}
  \begin{center}
    \includegraphics[width=.8\textwidth]{applications/cngs-general.eps}
  \end{center}
  \begin{itemize}
...
\begin{frame}{CERN Neutrinos to Gran Sasso project}
  \only<1> {
    \begin{center}
      \includegraphics[width=.9\textwidth]{applications/cngs-timing-31.eps}
    \end{center}
  }
  ...
  \begin{columns}[c]
    ...
    \column{.4\textwidth}
    \begin{center}
      \includegraphics[height=0.75\textheight]{applications/lngs_installation.eps}
    \end{center}
  \end{columns}
  }
...
\begin{frame}{Thank you}
    ...
    \begin{center}
    \includegraphics[height=4.0cm]{misc/white_rabbit_end.eps}
    \end{center}
...
\begin{frame}{Link Delay Model}
 \begin{center}
 \includegraphics<1>[height=4cm]{protocol/wrLinkModel_1.eps}
 \includegraphics<2>[height=4cm]{protocol/wrLinkModel_init.eps}
 \end{center}
\end{frame}
...
\begin{columns}[c]
  ...
  \column{0.3\textwidth}
	\begin{center}
	\includegraphics[width=1.1\textwidth]{protocol/wr-ptp-exchange.eps}
	\end{center}
\end{columns}
...
\begin{frame}{White Rabbit Network}
    ...
    \end{itemize}
    \begin{center}
    \includegraphics[width=.5\textwidth]{network/wr_network-enhanced_pro.eps}
    \end{center}
\end{frame}
...
\begin{frame}{White Rabbit Switch}
	...
	\begin{center}
	\includegraphics[width=\textwidth]{switch/wrSwitch.ps}
	\end{center}
	\end{block}
\end{frame}
...
\begin{frame}{WR Switch: hardware}
	\begin{center}
	\includegraphics[width=.7\textwidth]{switch/scb_backplane.ps}
	\end{center}
	\begin{itemize}
...
\begin{frame}{WR Switch: gateware}
	...
	\begin{center}
	\includegraphics[width=.9\textwidth]{switch/switch_hdl.ps}
	\end{center}
\end{frame}
...
\begin{frame}{WR PTP Core: interfaces}
	...
	\end{itemize}
	\begin{center}
		\includegraphics[width=.7\textwidth]{node/wrpc_overview.eps}
	\end{center}
\end{frame}

\begin{frame}{WR PTP Core: HDL design}
	\begin{center}
	\includegraphics[width=\textwidth]{node/wrpc_inside_simple.ps}
	\end{center}
\end{frame}
\begin{frame}{WR PTP Core: HDL design}
	\begin{center}
	\includegraphics[width=\textwidth]{node/wrpc_basic_top.ps}
	\end{center}
\end{frame}
