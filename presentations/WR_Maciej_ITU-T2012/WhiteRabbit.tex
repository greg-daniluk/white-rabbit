...
\begin{frame}{Link Asymmetry}
  ...
  \begin{center}
  \includegraphics[height=4cm]{fig/wrLinkModel_init.eps}
  \end{center}
...
\begin{frame}{Fixed Delays}
  ...
  \begin{center}
  \includegraphics[width=11.0cm]{fig/asymmetries.eps}
  \end{center}
...
\begin{frame}{WR-peer recognition and WR-data exchange}
  ...
  \column{.5\textwidth} 
    ...
    \begin{center}
    \includegraphics[width=5.0cm]{fig/WR-peer_recognision-1.eps}
    \newline
    Two WR devices
    \end{center}
  ...
  \column{.5\textwidth}
    ...
    \begin{center}
    \includegraphics[width=5.0cm]{fig/WR-peer_recognision-2.eps}
    \newline
...
\begin{frame}{White Rabbit Switch (V3)}
    ...
    \begin{center}
    \includegraphics[width=6.0cm]{fig/wrSwitchV3.ps}
    \end{center}
...
\begin{frame}{Proposed topology of WR network at CERN}
    ...
    \begin{center}
    \includegraphics[width=8cm]{fig/NT-overview.eps}
    \end{center}
