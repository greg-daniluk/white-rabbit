...
%   \end{columns}
      ...
      \begin{center}
	\includegraphics[width=.9\textwidth]{robustness/sub_domains-old.ps}
      \end{center}    
...
\begin{frame}{Time Distribution}
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      \item WRPTP \includegraphics[width=.5cm]{misc/big-tick.ps}  (possibly further improve)
      \item Hardware \includegraphics[width=.5cm]{misc/underconstruction.ps}
    \end{itemize}
  \end{itemize}
  ...
  \column{.3\textwidth}
      ...
      \begin{center}
	\includegraphics[width=1.1\textwidth]{robustness/WRPTPmodif_0.eps}
      \end{center}  
...
\begin{frame}{Time Distribution}
  ...
  \column{.3\textwidth}
      ...
      \begin{center}
	\includegraphics[width=1.1\textwidth]{robustness/WRPTPmodif_1.eps}
      \end{center}  
...
\begin{frame}{Time Distribution}
  ...
  \column{.3\textwidth}
      ...
      \begin{center}
	\includegraphics[width=1.1\textwidth]{robustness/WRPTPmodif_2.eps}
      \end{center}  
...
\begin{frame}{Quality of Service (WR Switch)}
  ...
  \begin{itemize}
    \item Cut-through \includegraphics[width=.5cm]{misc/big-tick.ps}
    \item Separate resources for Special Traffic \includegraphics[width=.5cm]{misc/underconstruction.ps}
    \item Output queuing \includegraphics[width=.5cm]{misc/underconstruction.ps}
    \item Switch firmware optimization (SWcore + RTU) \includegraphics[width=.5cm]{misc/underconstruction.ps}
  \end{itemize}
...
\begin{frame}{Forward Error Correction}
  ...
  \begin{itemize}
    ...
    \item Encoder \includegraphics[width=.5cm]{misc/big-tick.ps}  not optimized for resources
    \item Decoder \includegraphics[width=.5cm]{misc/underconstruction.ps}~~(MSc thesis):
    \begin{itemize}
  ...
  \end{itemize}
      ...
      \begin{center}
	\includegraphics[width=.9\textwidth]{robustness/FEC.v2.ps}
      \end{center}  
...
\begin{frame}{FEC: Linear Code and 8b/10b II}
 ...
 \begin{center}
 \includegraphics[scale=0.25]{robustness/8b_10b_Golay.ps}
 \end{center}
...
\begin{frame}{Topology Redundancy}
      ...
      \begin{center}
	\includegraphics[width=.65\textwidth]{network/WR_funny_network.ps}
      \end{center}
...
\begin{frame}{Topology Resolution}
  ...
  \end{itemize}
      ...
      \begin{center}
	\includegraphics[width=.9\textwidth]{robustness/TopologyResolutionUnit.eps}
      \end{center}
...
\begin{columns}[c]
  ...
  \begin{itemize}
    ...
    \begin{itemize}
     ...
     \end{itemize}
    \item Basic concept  \includegraphics[width=.5cm]{misc/big-tick.ps}
    \item Implementation \includegraphics[width=.5cm]{misc/underconstruction.ps}
  \end{itemize}

 \column{.35\textwidth}

      \begin{center}
	\includegraphics[width=1.1\textwidth]{robustness/portRoles.v2.eps}
      \end{center}
...
\begin{frame}{Link Aggregation Control Protocol plus FEC II}
      ...
      \begin{center}
	        \includegraphics[scale=0.30]{robustness/WR_LA_3.ps}
      \end{center}
\end{frame}
...
%	\includegraphics[width=1.0\textwidth]{fig/NT-overview.v2.eps}
	\includegraphics[width=0.8\textwidth]{applications/CERN/NT-overview_legend.eps}
      \end{center}  
...
\begin{frame}{WR@CERN: VLANs}
      ...
      \begin{center}
	\includegraphics[width=1.1\textwidth]{applications/CERN/NT-VLANs.v2.eps}
      \end{center}  
...
\begin{frame}{WR@CERN: Time distribution}
      ...
      \begin{center}
	\includegraphics[width=.7\textwidth]{applications/CERN/NT-timing.v2.eps}
      \end{center}  
...
\begin{frame}{WR@GSI: Overview}
      ...
      \begin{center}
	\includegraphics[scale=0.30]{applications/gmt-at--fair.ppt.ps}
      \end{center}  
