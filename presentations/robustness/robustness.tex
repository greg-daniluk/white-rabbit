...
\begin{figure}[tbp] % float placement: (h)ere, page (t)op, page (b)ottom, other (p)age
  ...
  \includegraphics[height=2.65in,keepaspectratio]{hierarchy}
...
\begin{figure}[tbp] % float placement: (h)ere, page (t)op, page (b)ottom, other (p)age
  ...
  \includegraphics[height=6cm,keepaspectratio]{layer1redudnancy2}
...
\begin{figure}[tbp] % float placement: (h)ere, page (t)op, page (b)ottom, other (p)age
  \centering
  \includegraphics[width=9cm,keepaspectratio]{network_topology_0}
...
\begin{figure}[tbp] % float placement: (h)ere, page (t)op, page (b)ottom, other (p)age
  ...
  \includegraphics[width=9cm,keepaspectratio]{network_topology}
...
GSI : $\sim$4 km; t$_{HP}$ $\approx$  89$\mu$s [GW:  100$\mu$s]
  ...
  \includegraphics[height=6.2cm,keepaspectratio]{granuality_window}
...
%	\includegraphics[height=6.2cm,keepaspectratio]{broadcast_ber.jpg}
	  ...
	  \includegraphics[width=6cm,keepaspectratio]{broadcast_ber}
...
\begin{center}
  ...
  \includegraphics[scale=0.30]{dropped_packet}
...
%	\includegraphics[scale=0.35]{biterror.jpg}
  ...
  \includegraphics[scale=0.35]{biterror}
