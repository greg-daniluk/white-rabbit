...
\subsection{}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\setbeamertemplate{background}{\includegraphics[width=0.95\paperwidth]{../../figures/misc/accelerators_background.eps}} 
...
% \subsection{}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\setbeamertemplate{background}{\includegraphics[width=0.95\paperwidth]{../../figures/misc/accelerators_background2.eps}} 
%  \addtobeamertemplate{block begin}{\pgfsetfillopacity{0.5}}{\pgfsetfillopacity{0.5}}
%  \addtobeamertemplate{block alerted begin}{\pgfsetfillopacity{0.5}}{\pgfsetfillopacity{1}}
%  \addtobeamertemplate{block example begin}{\pgfsetfillopacity{0.5}}{\pgfsetfillopacity{1}}
\begin{frame}{Introduction}
...
\pause
%       \includegraphics<1-3>[width=6.5cm]{../../figures/applications/CERN/accelerators.eps}
      \includegraphics[width=6.0cm]{../../figures/applications/cngs-overview.v3.eps}
    \end{center}
\end{columns}
...
\begin{columns}[c]
  ...
  \column{0.5\textwidth}
    \begin{center}
      \includegraphics[width=4.0cm]{../../figures/misc/emc2.eps}
    \end{center}
\end{columns}
...
\begin{center}
  \begin{itemize}
	...
	\end{itemize}
  \end{itemize}
	\includegraphics[width=.75\textwidth]{../../figures/misc/synce.eps}
\end{center}
\end{frame}
...
\begin{frame}{CERN Neutrinos to Gran Sasso (CNGS)}
    ...
    \begin{center}
      \includegraphics[width=0.9\textwidth]{../../figures/applications/cngs-general.eps}
    \end{center}
...
\begin{frame}{CERN Neutrinos to Gran Sasso (CNGS)}
      ...
      \includegraphics[width=0.9\textwidth]{../../figures/applications/cngs-timing-1.v2.eps} 
...
\begin{frame}{Old CNGS time transfer}
      ...
      \begin{center}
      \includegraphics[width=0.9\textwidth]{../../figures/applications/cngs-timing-2.eps}
      \end{center}
...
\begin{frame}{New time transfer with WR}
      ...
      \begin{center}
%       \vspace{-0.3cm}
      \includegraphics[width=0.9\textwidth]{../../figures/applications/cngs-timing-3.eps}
...
% 		\pause
		\vspace{-0.5cm}
		\includegraphics<1>[height=0.75\textheight]{../../figures/applications/lngs_installation.eps}
		\includegraphics<2>[height=0.75\textheight]{../../figures/applications/lngs_installation-dimmed.eps}
		\end{center}
  \end{columns}
...
\begin{frame}{CNGS performance measurement (2)}
  ...
  \begin{columns}[c]
	\column{0.6\textwidth}
	  ...
	  \end{center}
	  \begin{center}
	\includegraphics[width=0.93\textwidth]{../../figures/measurements/timeErrors.eps}
	  \end{center}
	\column{0.6\textwidth}
% 		\vspace{-0.4cm}
		\begin{center}
...
\begin{frame}{CNGS performance results (2)}
  ...
  \begin{columns}[c]
	\column{0.5\textwidth}
		\begin{center}
		\includegraphics[width=0.9\textwidth]{../../figures/measurements/cngs_oADEV3.eps}
		\end{center}
		\begin{center}
...
\begin{frame}{CNGS performance results (3)}
	...
	\begin{center}
		\includegraphics[height=0.6\textheight]{../../figures/measurements/cngs_temp.vs.filteredTE3.eps}
...
\begin{frame}{Temperature tests setup (1)}
	...
	\begin{center}
	\includegraphics[width=1.0\textwidth]{../../figures/measurements/tempTests-setup.eps}
...
% 		\includegraphics[width=1.0\textwidth]{figs/tempTests-1-temps.eps}
		\includegraphics[width=1.0\textwidth]{../../figures/measurements/temp-profile-1.eps}
		\end{center}
\vspace{-0.5cm}
		\begin{center}
		\includegraphics[width=1.0\textwidth]{../../figures/measurements/tempTests-1-setup.eps}
		\end{center}
	\column{0.5\textwidth}
		\hspace{-1cm}
		\begin{center}
% 		\includegraphics[width=1.0\textwidth]{figs/tempTests-2-temps.eps}
		\includegraphics[width=1.0\textwidth]{../../figures/measurements/temp-profile-2.eps}
		\end{center}
		\vspace{-0.5cm}
		\begin{center}
		\includegraphics[width=1.0\textwidth]{../../figures/measurements/tempTests-2-setup.eps}
		\end{center}
  \end{columns}
...
% 		  $\approx 8$ ps per $1^{\circ}$C  & $\approx 4$ ps per $1^{\circ}$C  \\ 
	...
	\column{0.5\textwidth}
		\hspace{-0.8cm}
		\begin{center}
		\includegraphics[width=1.13\textwidth]{../../figures/measurements/tempTests-2-combo-detrended.eps}
		\end{center}
