...
\begin{columns}[c]
	...
	\column{0.3\textwidth}
		...
		\pause
		\hspace{-0.5cm}
		\includegraphics[width=1.1\textwidth]{misc/rabbit.eps}
		\end{center}
	\end{columns}
...
\begin{frame}{Data distribution in WR Control System}
    ...
    \begin{center}
    \includegraphics<1>[width=1.1\textwidth]{applications/CERN/WRControlNetwork.ps} \pause
    \includegraphics<2>[width=1.1\textwidth]{applications/CERN/WRControlNetwork2.ps}
    \end{center}
...
\begin{columns}[c]
  ...
  \column{.6\textwidth}
   ...
   % \hspace{-6cm}
    \begin{center}
    \includegraphics[height=0.6\textheight]{robustness/CommunicationChannel.ps}
    \end{center}
...
\begin{frame}{Data Redundancy}
  ...
  \end{itemize}
  	...
  	\begin{center}
      \includegraphics[width=.7\textwidth]{robustness/FEC.eps}
    \end{center}
...
% 
  \column{0.6\textwidth}
    \begin{center}
    \includegraphics[width=0.65\textwidth]{network/wr_network-new.ps}
    \end{center}
\end{columns}
...
% 
  \column{0.6\textwidth}
    \begin{center}
    \includegraphics<1>[width=0.65\textwidth]{network/wr_network-new.ps} \pause
    \includegraphics<2>[width=0.9\textwidth]{applications/CERN/event3.eps}
    \end{center}
...
\begin{frame}{WR at CERN}
      ...
      \begin{center}
      \includegraphics[width=.7\textwidth]{applications/CERN/accNetworks.eps}
      \end{center}
...
\begin{frame}{WR at CERN}
    ...
    \begin{center}
      \includegraphics[width=.8\textwidth]{applications/CERN/NT-overview.eps}
    \end{center}
...
\begin{frame}{Ethernet Clock distribution a.k.a. Distributed DDS}
  \begin{center}
    \includegraphics[width=\columnwidth]{applications/remote_dds.eps}
  \end{center}
...
\begin{frame}{Distributed oscilloscope}
  \begin{center}
    \includegraphics[width=0.9\textwidth]{applications/distr_oscill.eps}
    \end{center}
    \begin{block}{}
      \begin{itemize}
...
\begin{frame}{Time Transfer}
  \begin{columns}[c]
    ...
    \column{.4\textwidth}
      \begin{center}
	\includegraphics[width=0.9\textwidth]{applications/CNGS2.eps}
      \end{center}
    \column{.01\textwidth}
  \end{columns}
\end{frame}
...
\begin{frame}{Beam Position Monitoring}
  ...
  \begin{columns}[c]
    ...
    \begin{center}
      \includegraphics[width=1.0\textwidth]{applications/sirius8.eps}
    \end{center}
...
\begin{frame}{National Instruments}
    ...
    \begin{center}
      \includegraphics<1>[width=1.0\textwidth]{applications/ni.eps} \pause
      \includegraphics<2>[width=1.0\textwidth]{applications/NI2.eps} 
    \end{center}
...
% 	\end{itemize}
    ...
    \begin{center}
      \includegraphics[width=1.0\textwidth]{ohwr/ohr_logo.eps}  
    \end{center}
...
\begin{frame}{Open Hardware Repository \href{http://ohwr.org}{-- www.ohwr.org}}
 ...
 \begin{center}
   \includegraphics[height=6cm]{ohwr/ohr_spec_top.eps}
 \end{center} 
...
\begin{frame}{Example of mechanics licenced with the CERN OHL}
  \begin{center}
    \includegraphics[height=5cm]{ohwr/worm-farm-008.eps}
    \includegraphics[height=5cm]{ohwr/rotocaster.eps}
...
\begin{frame}{Open Hardware - how does it work ?}
      ...
      \begin{center}
	\includegraphics[height=0.8\textheight]{ohwr/openHW.eps} 
      \end{center}
...
\column{2.0in}
    \begin{center}
    \includegraphics[width=3.5cm]{misc/fourRabbits.ps}
    \end{center}
\column{2.0in}
    \begin{center}
...
\begin{center}
\includegraphics[width=9.5cm]{misc/WRfamily.ps}
\end{center}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Q\&A}
...
\begin{columns}[c]
  ...
  \column{0.6\textwidth}
    \begin{center}
      \includegraphics[width=6.5cm]{applications/CERN/accelerators.eps}
    \end{center}
\end{columns}
...
\begin{frame}{A simplified explanation of CERN control system (1)}
      ...
      \begin{center}
      \includegraphics[width=1.0\textwidth]{applications/CERN/event1.eps}
      \end{center}
...
\begin{frame}{A simplified explanation of CERN control system (2)}
      ...
      \begin{center}
      \includegraphics[width=1.0\textwidth]{applications/CERN/event2.eps}
      \end{center}
...
\begin{frame}{A simplified explanation of CERN control system (3)}
      ...
      \begin{center}
      \includegraphics[width=.8\textwidth]{applications/CERN/event3.eps}
      \end{center}
...
\begin{columns}[c]
  ...
  \column{0.6\textwidth}
    \begin{center}
      \begin{center}
      \includegraphics[width=.8\textwidth]{applications/CERN/gw.eps}
      \end{center}
    \end{center}
\end{columns}
...
\begin{frame}{Link Asymmetry}
  ...
  \begin{center}
  \includegraphics[height=4cm]{protocol/wrLinkModel_init.eps}
  \end{center}
...
\begin{frame}{Fixed Delays}
  ...
  \begin{center}
  \includegraphics[width=11.0cm]{protocol/asymmetries.eps}
  \end{center}
...
\begin{frame}{WR-peer recognition and WR-data exchange}
  ...
  \column{.5\textwidth} 
    ...
    \begin{center}
    \includegraphics[width=5.0cm]{protocol/WR-peer_recognision-1.eps}
    \newline
    Two WR devices
    \end{center}
  ...
  \column{.5\textwidth}
    ...
    \begin{center}
    \includegraphics[width=5.0cm]{protocol/WR-peer_recognision-2.eps}
    \newline
...
\begin{frame}{Modified Best Master Clock Algorithm (mBMCA)}
    ...
    \begin{center}
    \includegraphics[height=7.0cm]{protocol/mBMCvsBMC.eps}
    \end{center}
