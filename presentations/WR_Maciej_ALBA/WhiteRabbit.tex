...
\begin{frame}{White Rabbit Network Components}
    ...
    \begin{center}
    %\includegraphics<1>[width=1.0\textwidth]{fig/WRNcomponents.pdf}  \pause
...
%     \begin{center}
%     \includegraphics<1>[width=1.0\textwidth]{fig/stm.pdf}       \pause
%     \includegraphics<2>[width=1.0\textwidth]{fig/svec4_res.pdf} \pause
%     \includegraphics<3>[width=1.0\textwidth]{fig/WRCarrier.pdf}
%     \end{center}
