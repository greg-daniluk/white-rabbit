...
\pgfdeclareimage[height=0.5cm]{wr-logo}{../../figures/logo/WRlogo.jpg}
...
\begin{center}
\includegraphics[width=\columnwidth]{../../figures/misc/dmtd.pdf}
\end{center}
\begin{itemize}
...
%Floor to Eva (separate presentation)
...
\begin{frame}{Synchronization redundancy support}
    ...
    \begin{center}
    \includegraphics[width=0.9\textwidth]{../../figures/robustness/wrCRS2.pdf}
    \end{center}
...
\begin{center}
\includegraphics[width=6.5cm]{../../figures/switch/wrs2_sw_block.pdf}
\end{center}
\begin{itemize}
