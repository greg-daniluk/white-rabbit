...
\begin{columns}[c]
  ...
  \column{0.55\textwidth}         
    ...
    \begin{center}
      ...
      \includegraphics<4>[width=0.85\textwidth]{applications/cta.eps}          \pause
      \includegraphics<5>[width=0.85\textwidth]{applications/KM3NeT.eps}       
    \end{center}
...
\begin{frame}{White Rabbit Network Components}
    ...
    \includegraphics<2>[width=1.0\textwidth]{network/WRNcomponents-2.eps}
    \end{center}
...
\small
    ...
    \begin{center}
      \includegraphics<1>[width=0.9\textwidth]{node/svec.eps} \pause
      \includegraphics<2>[width=0.7\textwidth]{node/stm.eps}       \pause
      \includegraphics<3>[width=0.5\textwidth]{node/pxi.eps} 
    \end{center}
