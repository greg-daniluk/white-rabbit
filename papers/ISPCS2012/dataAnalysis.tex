...
\begin{figure}[!t]
\centering
\includegraphics[width=0.5\textwidth]{measurements/histogram-small.eps}
...
\begin{figure}[!t]
\centering
\includegraphics[width=0.4\textwidth]{measurements/cngs_oADEV3.eps}
...
\begin{figure}[!t]
\centering
\includegraphics[width=0.4\textwidth]{measurements/MTIE2.eps}
...
\begin{figure}[!t]
\centering
\includegraphics[width=0.4\textwidth]{measurements/cngs_temp.vs.TE.eps}
...
\begin{figure}[!t]
\centering
\includegraphics[width=0.5\textwidth]{measurements/cngs_temp.vs.filteredTE3.eps}
...
\begin{figure}[!t]
\centering
\includegraphics[width=0.5\textwidth]{measurements/cngs_reference.eps}
...
\begin{figure}[!t]
\centering
\includegraphics[width=0.5\textwidth]{measurements/chamber-test.eps}
