...
\begin{center}
	\includegraphics[scale=0.40]{robustness/deliveryDelayChart.ps}
...
\begin{center}
	\includegraphics[scale=0.35]{network/hierarchy2.ps}
...
\begin{center}
	\includegraphics[scale=0.35]{robustness/topologyConsideration.ps}
...
\begin{center}
	\includegraphics[scale=0.25]{robustness/threeTopologies.ps}
...
\begin{center}
	\includegraphics[scale=0.25]{robustness/fullyRedundantTopologies.ps}
